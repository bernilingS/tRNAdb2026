...
There has been growing interest in tRNAs, promoted by
...
particular release were obtained. A more detailed description, e.g.,
...
In order display alignments properly, legacy one letter codes for modifications were retained.  
...
However, because most entries in the tRNAdb stem from semi-automatic annotation together with manual curation, fringe cases that deviate from established tRNA properties are likely
