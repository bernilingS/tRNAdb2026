...
\PFS{When access to the tRNAdb was interrupted due to technical issues in
  ...
  new, solid technical foundation, and to include an API for automatic data
...
Archaeal genomes were sourced from the BV-BRC database~\cite{bvbrc2022}, accessed October 2024. Only good quality genomes were retained for further analysis, and genome quality was assessed by CheckM2 ($\geq$85\% complete,
