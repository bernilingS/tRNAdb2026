...
The updated relational schema supports a versioning system which separates the legacy dataset and data contained in tRNAdb 2.0 update. For every version, data sources, software (and their versions) used and general worklflows are documented. Additionally, every version contains a public version string which informs the user how the sequences were obtained. Subsequent updates of the tRNAdb dataset will be published with a corresponding updated version. To enable a sustainable update procedure, we implemented a graphical user interface for import, normalization and duplicate detection of new entries.
