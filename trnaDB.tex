...
quality control for all candidate entries except the \TODO{******}
...
{\tiny\TODO{PFS thinks the sentence can be deleted:} Here, we give a short statistics about the entries in the tRNAdb. Besides the total number of entries, we also report the number of unique tRNA sequences included in the database.}

\PFS{The database lists $330\,261$ entries of mitochordrial tRNA sequences}
