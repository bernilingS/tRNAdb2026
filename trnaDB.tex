...
\section{Funding}
This work was funded in part by the Deutsche Forschungsgemeinschaft (DFG, German Research Foundation) under Germany's Excellence Strategy - EXC-3105/1 - 533765739, the Austrian Science Fund (FWF) F80 RNAdeco, the German Federal Ministry of Research, Technology and Space (BMFTR) through Leipzig RNA Bioinformatics Center (RBC) of the German Network for Bioinformatics Infrastructure (de.NBI) sustained via Forschungszent\-rum J\"{u}hlich.%  (NFB: \# XXXXXXX and \# YYYYYYY).
