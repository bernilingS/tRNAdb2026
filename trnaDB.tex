...
There has been rising interest in tRNAs, promoted by
...
particular release were obtained. A detailed description, including 
...
In order to display alignments properly, legacy one-letter codes for modifications were retained.
...
used in tRNAdb and MODOMICS can be found in the supplement and on the database webpage.
...
mitochondrial tRNAs). When an anticodon was annotated, we compared it to the one identified by Infernal (at the center of the
...
The database lists $330\,261$ mitochondrial tRNA entries
