...
Mitochondrial tRNAs show a comparatively even distribution with respect to
their abundance, ranging from $14\,692$ entries for Glu to $16\,734$
entries for Met,
\TODO{can we elaborate a sentence or two here?} with the exception of Ser1 and Leu1, which code for the two amino acids that have two tRNAs in many mitochondria. Mitochondrial tRNA  Lys is the only tRNA utilizing a notable amount of a secondary anticodon (Fig~\ref{Aminoacidamounts}b).
\begin{figure}
